...
L.chestMail = "Equipment: Mail Chest (SFX when walking)"
L.dundun = "Zone: Abundance (Dundun 'talking head' only)"
L.valeera = "Zone: Delves (Valeera in-combat comments)"
L.xalatath = "Zone: Dungeons (Xal'atath M+ comments)"
L.lightblindedVanguard = "Zone: Raid (Lightblinded Vanguard in-combat comments)"
